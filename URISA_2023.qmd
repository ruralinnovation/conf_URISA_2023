...
| Releases | 2019-2022 | 2022 - *Ongoing* |
...
By combining the definition it better encapsulates places that are rural in character.
...
For more information see [Defining rural America: The consequences of how we count for more information](https://ruralinnovation.us/blog/defining-rural-america/).
...
## Results Rural Areas underestimated in statistics (2a) {background-image="img/URISA_GISPro2023_SpeakerPPTTemplate.pptx.svg" background-size="auto"}
...
![](img/rural_nonrural_broadband_gap.png){fig-align="center"}
...
-   Getting better at counting people (use Housing unit, Microsoft building foot print)

-   Upcoming FCC updates (API?)

-   Fabric data: having locations will help comparing both sources
...
Interested about [CORI](https://ruralinnovation.us):
